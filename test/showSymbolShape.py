...
conv2 = mx.symbol.Convolution(data=relu1, kernel=(3, 3), pad=(1, 1), num_filter=64)
...
conv6 = mx.symbol.Convolution(data=relu5, kernel=(3, 3), pad=(1, 1), num_filter=256)
...
conv8 = mx.symbol.Convolution(data=relu7, kernel=(3, 3), pad=(1, 1), num_filter=512)
...
conv9 = mx.symbol.Convolution(data=pool8, kernel=(3, 3), pad=(1, 1), num_filter=512)
...
conv10 = mx.symbol.Convolution(data=relu9, kernel=(3, 3), pad=(1, 1), num_filter=512)
bn10 = mx.symbol.BatchNorm(data=conv10)
relu10 = mx.symbol.Activation(data=bn10, act_type="relu")
pool10 = mx.symbol.Pooling(data=relu10, pool_type="max", kernel=(2, 2), stride=(2, 2))
# dropout10 = mx.symbol.Dropout(data=pool10, p=0.5)

conv11 = mx.symbol.Convolution(data=pool10, kernel=(1, 1), pad=(0, 0), num_filter=64)  # reduce dimensions
relu11 = mx.symbol.Activation(data=conv11, act_type="relu")

flatten = mx.symbol.Flatten(data=relu11)
