...
conv1 = mx.symbol.Convolution(data=data, kernel=(8, 8), stride=(4, 4), num_filter=128)
...
conv2 = mx.symbol.Convolution(data=dropout1, kernel=(5, 5), pad=(2, 2), num_filter=256)
...
conv3 = mx.symbol.Convolution(data=dropout2, kernel=(5, 5), pad=(2, 2), num_filter=256)
...
conv4 = mx.symbol.Convolution(data=dropout3, kernel=(5, 5), pad=(2, 2), num_filter=256)
...
conv5 = mx.symbol.Convolution(data=dropout4, kernel=(3, 3), pad=(2, 2), num_filter=128)
