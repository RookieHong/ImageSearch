...
def get_symbol(num_classes=10):
    ...
    # conv7 = mx.symbol.Convolution(data=dropout6, kernel=(3, 3), pad=(1, 1), num_filter=512)
    ...
    #
    # conv8 = mx.symbol.Convolution(data=dropout7, kernel=(3, 3), pad=(1, 1), num_filter=512)
