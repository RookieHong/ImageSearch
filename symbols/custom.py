...
def get_symbol(num_classes=10):
    ...
    conv1 = mx.symbol.Convolution(data=data, kernel=(8, 8), stride=(2, 2), num_filter=128)
    ...
    conv3 = mx.symbol.Convolution(data=dropout2, kernel=(3, 3), pad=(1, 1), num_filter=512)
    ...
    conv4 = mx.symbol.Convolution(data=dropout3, kernel=(3, 3), pad=(1, 1), num_filter=128)
    ...
    flatten = mx.symbol.Flatten(data=dropout4)
